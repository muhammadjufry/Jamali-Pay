...
export default function Hero() {
  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col items-center justfiy-center gap-4 px-4 lg:py-32 py-24">
      <motion.span
      ...
      <motion.h2
        ...
        className="lg:text-[40px] text-4xl leading-[45px] font-bold text-center"
      >
      ...
      <motion.p
        ...
        className="max-w-xl text-center text-[17.5px] leading-8 dark:text-white text-slate-700"
      >
      ...
      >
        <a href="/docs">
          <button className="py-3 px-5 bg-white dark:bg-gray-800 dark:border-white border-2 border rounded-md">
            Read Docs
          </button>
        </a>
        <a href="/signup">
